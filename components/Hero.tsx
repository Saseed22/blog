  ...
  return (
      <div className='flex items-center justify-between  bg-yellow-400 border-y border-black py-10 lg:py-0'>
          <div className='px-10 space-y-5'>
              ...
              <h2 className='lg:text-lg font-semibold'>its easy and free to post your thinking on any topic and connect with milions od people</h2>
          </div> 
          <img className='hidden md:inline-flex h-30 lg:h-full'
